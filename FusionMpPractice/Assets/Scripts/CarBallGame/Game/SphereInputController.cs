...
public class SphereInputController : NetworkBehaviour, INetworkRunnerCallbacks
{
    ...
    public void OnInput(NetworkRunner runner, NetworkInput input)
    {
        ...
        var data = new SphereInputData()
        {
            HorizontalValue = m_horizontal,
            VerticalValue = m_vertical
        };
